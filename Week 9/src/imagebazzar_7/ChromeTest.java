...
public class ChromeTest {
    static String url = "https://www.imagesbazaar.com/signin";
    static String expectedTitle = "Imagesbazaar : Largest Collection of Indian Images and Videos";// expected title
